...
- (void)setSelecTitleM:(NSString *)selecTitleM {
    objc_setAssociatedObject(self, @selector(selecTitleM), selecTitleM, OBJC_ASSOCIATION_COPY);
...
- (void)setSelectColorM:(UIColor *)selectColorM {
    objc_setAssociatedObject(self, @selector(selectColorM), selectColorM, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (void)setAddRadiuM:(CGFloat)addRadiuM {
    ...
    objc_setAssociatedObject(self, @selector(addRadiuM), @(addRadiuM), OBJC_ASSOCIATION_ASSIGN);
}
...
- (void)setBorderWidthM:(CGFloat)borderWidthM {
    ...
    objc_setAssociatedObject(self, @selector(borderWidthM), @(borderWidthM), OBJC_ASSOCIATION_ASSIGN);
}
...
- (void)setBorderColorM:(UIColor *)borderColorM {
    ...
    objc_setAssociatedObject(self, @selector(borderColorM), borderColorM, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
